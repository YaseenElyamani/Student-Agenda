...
const hasGoogleAuth = !!GOOGLE_CLIENT_ID && GOOGLE_CLIENT_ID !== "placeholder";

/* Separate component so useGoogleLogin hook only runs when Google auth is available */
function GoogleSignInButton({ mode, onSuccess, onError }: {
  mode: "login" | "register";
...
export default function LoginModal({ onLogin, onClose, sessionExpired, onClearExpired }: LoginModalProps) {
          ...
          <>
            ...
            <div className={styles.hero}>
              ...
              <p className={styles.tagline}>
                Sign in to save your courses and sync across devices.
              </p>
            </div>
            ...
            <div className={styles.fields}>
              ...
              <p className={styles.forgotLink}>
                <button className={styles.switchBtn} onClick={() => { onClose(); navigate("/forgot-password"); }}>
                  Forgot password?
                </button>
              </p>
